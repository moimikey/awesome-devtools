...
- [BeginThings](https://beginthings.com) - 96+ free browser-based tools for developers — JSON formatter, regex tester, base64 encoder, image compressor, QR code generator, and more. No signup required.
