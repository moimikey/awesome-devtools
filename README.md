...
- [ToolsNova](https://toolsnova.net) - 154 free browser-based tools — JSON formatter, base64 encoder, JWT decoder, regex tester, diff checker, UUID generator, CSS minifier and more. No signup, works offline as a PWA.
