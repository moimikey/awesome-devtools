...
- [PDF Mavericks](https://www.pdfmavericks.com) - Browser-based PDF and JSON toolkit. 25+ tools: merge, split, compress, rotate, convert, sign PDFs; format/validate JSON, Base64, JWT, YAML, regex. 100% client-side. No signup.
