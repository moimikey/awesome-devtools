...
- [Quietbench Regex Tester](https://quietbench.dev/regex-tester) - Live regex testing with match highlighting and plain-English pattern explanations. No signup required.
...
- [Quietbench JSON Formatter](https://quietbench.dev/json-formatter) - Format, validate, and minify JSON instantly in the browser. Tree view included. No signup required.
